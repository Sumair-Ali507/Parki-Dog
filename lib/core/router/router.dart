  ...
  Route onGenerateRoute(RouteSettings settings) {
    switch (settings.name) {
      ...
      case '/home/current-checkin/dogs':
        ...
        return PageTransition(
            child: ViewAllDogs(dogs), type: PageTransitionType.rightToLeftWithFade, settings: settings);

      case '/breed-selector':
        return PageTransition(child: const BreedSelector(), type: PageTransitionType.bottomToTop, settings: settings);

      case '/date-selector':
        return PageTransition(child: const DateSelector(), type: PageTransitionType.bottomToTop);
